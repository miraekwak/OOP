...
public: 
	void ride() { std::cout << "Ride bus!" << std::endl; } 
};
class Taxi : public RideStrategy { 
public: 
	void ride() { std::cout << "Ride Taxi!" << std::endl; }
};
 class Person { 
 public: 
	 Person(RideStrategy *ride) { rideStrategy = ride; } 
	 void run() { std::cout << "I run!" << std::endl; } 
	 void walk() { std::cout << "I walk!" << std::endl; } 
	 virtual void ride() { rideStrategy->ride(); }
	 void setRideStratage(RideStrategy* ride) { rideStrategy = ride;} 
 protected: 
 ...
 public: 
	 ...
	 void ride() { std::cout << "James: " << std::endl; rideStrategy->ride(); } 
 }; 
 int main() {
